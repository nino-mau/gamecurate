    ...
    <section class="footer-top-div bg-primary d-flex justify-content-between align-items-center">
        ...
        <div role="list" class="footer-socials">
            <a href="" class="icons text-white me-4">
                <img class="svg hvr-float" data-icon-facebook>
            </a>
            <a href="" class="icons text-white me-4">
                <img class="svg hvr-float" data-icon-twitter>
            </a>
            <a href="" class="icons text-white me-4">
                <img class="svg hvr-float" data-icon-github>
            </a>
            <a href="" class="icons text-white me-4">
                <img class="svg hvr-float" data-icon-insta>
            </a>
            <a href="" class="icons text-white me-4">
                <img class="svg hvr-float" data-icon-linkedin>
            </a>
            <a href="" class="icons text-white me-4">
                <img class="svg hvr-float" data-icon-youtube>
            </a>
        </div>
    </section>
    <section class="footer-middle-div">
        <div class="containerDiv container text-center text-md-start h-100">
            <div class="row h-100">
                <div class="footer-site-icon col-md-3 col-lg-4 col-xl-3 mx-auto d-flex justify-content-center align-items-center">
                    <a class="link" href="Index"><img class="svg" data-icon-site-footer></a>
                </div>
                <div class="content-div col-md-2 col-lg-2 col-xl-2 mx-auto d-flex flex-column justify-content-center gap-1 align-items-start">
                    ...
                    <a href="https://popper.js.org/docs/" class="link">Popper.js</a>
                ...
                <div class="content-div col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 d-flex flex-column justify-content-center gap-1 align-items-start">
                    ...
                    <hr class="line mb-4 mt-0 d-inline-block" />
                    <p class="txt"><img class="svg" data-icon-address> 36 Rue de Placeholder, 38240</p>
                    <p class="txt"><img class="svg" data-icon-mail> nino.placeholder@gmail.com</p>
                    <p class="txt"><img class="svg" data-icon-call> + 01 234 567 88</p>
                    <p class="txt"><img class="svg" data-icon-print> + 01 234 567 89</p>
                </div>
            </div>
        </div>
    </section>
